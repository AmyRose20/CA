class T_Button
{
  ...
  using the dist() function. This value will be stored in the variable 'd'. If the value of 'd' is < the 
  radius of the button 'on' will be true and 'off' will be false. Functions within draw() and mousePressed()
  that need 'on' to be true in the main program will be able to be carried out. If the value of 'd' is > the 
  radius, then 'on' will be false and 'off' will remain true and no function within draw() or mousPressed() that
  need 'on' to be true will be carried out. */
